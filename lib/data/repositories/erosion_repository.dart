...
abstract class ErosionRepository {
  ...
  /// Fetch granular sub-district / taluk boundaries and localized RUSLE metrics
  Future<List<TalukErosionModel>> getTaluks({String? districtName, String? year});

  /// Fetch a single taluk by its unique ID
  Future<TalukErosionModel?> getTalukById(String id);
